...
namespace Smev3Client
{
    internal class Smev3Client : ISmev3Client
    {
        ...
        public async Task<
            Smev3ClientResponse<SendRequestResponse>
        > SendRequestAsync<TServiceRequest>(
            SendRequestExecutionContext<TServiceRequest> context,
            ...
            where TServiceRequest : new()
        {
            ...
            try
            {
                ...
                var soapEnvelopeBody = await httpResponse
                    .Content.ReadSoapBodyAsAsync<SendRequestResponse>(cancellationToken)
                    .ConfigureAwait(false);
        ...
        /// </summary>
        public async Task<Smev3ClientResponse> GetResponseAsync(
            Uri namespaceUri,
        ...
        /// </summary>
        public async Task<
            Smev3ClientResponse<GetResponseResponse<TServiceResponse>>
        > GetResponseAsync<TServiceResponse>(
            Uri namespaceUri,
            string rootElementLocalName,
            CancellationToken cancellationToken
        )
            where TServiceResponse : new()
        {
            ...
            var data = await response
                .ReadSoapBodyAsAsync<GetResponseResponse<TServiceResponse>>(cancellationToken)
                .ConfigureAwait(false);

            return new Smev3ClientResponse<GetResponseResponse<TServiceResponse>>(
                response.DetachHttpResponse(),
                data
            );
        }
        ...
        /// </summary>
        public async Task<Smev3ClientResponse<AckResponse>> AckAsync(
            Guid messageId,
            CancellationToken cancellationToken
        )
        {
            ...
            var envelope = new AckRequest(
                new AckTargetMessage { MessageID = messageId, Id = "SIGNED_BY_CALLER" },
                signer: _signer
            );
            ...
            var data = await httpResponse
                .Content.ReadSoapBodyAsAsync<AckResponse>(cancellationToken)
                .ConfigureAwait(false);
        ...
        )
        {
            ...
            var content = new ByteArrayContent(envelopeBytes, 0, envelopeBytes.Length);
            ...
            try
            {
                ...
                var faultInfo = await httpResponse
                    .Content.ReadSoapBodyAsAsync<SoapFault>(cancellationToken)
                    .ConfigureAwait(false);
