...
namespace Smev3Client
{
    public interface ISmev3Client : IDisposable
    {
        ...
        /// <param name="cancellationToken">Токен отмены</param>
        /// <returns></returns>
        Task<Smev3ClientResponse> GetResponseAsync(
            Uri namespaceUri,
        ...
        /// <summary>
        /// Получение сообщения из очереди входящих ответов с десереализацией ответа в тип T
        /// </summary>
        ...
        /// <param name="cancellationToken">Токен отмены</param>
        /// <returns></returns>
        Task<Smev3ClientResponse<AckResponse>> AckAsync(
            Guid messageId,
            CancellationToken cancellationToken
        );
    }
